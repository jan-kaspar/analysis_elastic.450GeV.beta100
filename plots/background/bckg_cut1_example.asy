...
datasets.push("DS-scheme4"); d_labels.push("\vbox{\hbox{8 Nov 2017}\hbox{fill 6368}\hbox{run 306381}}");
datasets.push("DS-scheme5"); d_labels.push("\vbox{\hbox{8 Nov 2017}\hbox{fill 6369}\hbox{run 306402}}");
