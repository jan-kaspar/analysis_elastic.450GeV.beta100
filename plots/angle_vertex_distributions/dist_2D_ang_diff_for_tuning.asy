...
plots.push("th_y_diffRL_vs_th_x_G"); x_scales.push(1e6); y_scales.push(1e6); lab_hs.push("$\th_x^{*}\ung{\mu rad}$"); lab_vs.push("$\De^{R-L}\th_y^{*}\ung{\mu rad}$"); y_mins.push(-150); y_maxs.push(+150);
