...
int SetScenario(const string &scenario, Biases &biases, Environment &env_sim, Analysis &anal_sim, Environment &env_rec, Analysis &anal_rec)
{
...

	{
		...
		if (scenario == "sh-thy")
		{
			...
			anal_rec.fc_L.Shift(0., v * th_y_sign);
			anal_rec.fc_R.Shift(0., v * th_y_sign);
			anal_rec.fc_G.Shift(0., v * th_y_sign);
		...
		if (scenario == "sh-thy-LRasym")
		{
			...
			anal_rec.fc_L.Shift(0., +v_LR_asym * th_y_sign);
			anal_rec.fc_R.Shift(0., -v_LR_asym * th_y_sign);
		...
		if (scenario == "sh-thy-TBuncor")
		{
			...
			anal_rec.fc_L.Shift(0., v_TB_uncorr * th_y_sign);
			anal_rec.fc_R.Shift(0., v_TB_uncorr * th_y_sign);
			anal_rec.fc_G.Shift(0., v_TB_uncorr * th_y_sign);
