...
Kinematics theta_x_two_arm_regr_LRavg(const HitData &h, const Environment &env)
{
...
Kinematics vtx_x_two_arm_regr_LRavg(const HitData &h, const Environment &env)
{
...
Kinematics theta_y_two_arm_regr_LRavg(const HitData &h, const Environment &env)
{
	Kinematics k = theta_y_one_arm_regr(h, env);
	k.th_y = (k.th_y_R + k.th_y_L) / 2.;
	return k;
}
...
Kinematics vtx_y_one_arm_regr(const HitData &h, const Environment &env)
{
	Kinematics k;
...
Kinematics vtx_y_two_arm_regr_LRavg(const HitData &h, const Environment &env)
{
	Kinematics k = vtx_y_one_arm_regr(h, env);
