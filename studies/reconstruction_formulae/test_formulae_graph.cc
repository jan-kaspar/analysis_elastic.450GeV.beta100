...
int main()
{
	...
	Test("theta_x_two_arm_regr_LRavg, th_x", rqTh_x, theta_x_two_arm_regr_LRavg);
	...
	Test("vtx_x_two_arm_regr_LRavg, vtx_x", rqVtx_x, vtx_x_two_arm_regr_LRavg);
	...
	Test("theta_y_two_arm_regr_LRavg, th_y", rqTh_y, theta_y_two_arm_regr_LRavg);
	Test("theta_y_two_arm_simple_regr, th_y", rqTh_y, theta_y_two_arm_simple_regr);

	printf("\n");
	printf("==================== vtx_y, one arm ====================\n");
	Test("vtx_y_one_arm_regr, vtx_y_L", rqVtx_y_L, vtx_y_one_arm_regr);

	printf("\n");
	printf("==================== vtx_y, two arm ====================\n");
	Test("vtx_y_two_arm_regr_LRavg, vtx_y", rqVtx_y, vtx_y_two_arm_regr_LRavg);
