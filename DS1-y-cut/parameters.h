...
unsigned int timestamp_min = 61064;
unsigned int timestamp_max = 64349;
...
void Init_45b_56t()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -122E-6; anal.cut1_si = 40E-6;
...
void Init_45t_56b()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -414E-6; anal.cut1_si = 40E-6;
	anal.cut2_a = 1.; anal.cut2_c = +1E-6; anal.cut2_si = 7E-6;

	//anal.cut3_c = 0.43; anal.cut3_si = 0.023;
	//anal.cut4_c = -0.055; anal.cut4_si = 0.031;

	anal.cut5_a = 0.105; anal.cut5_c = 0.276; anal.cut5_si = 0.08;
	anal.cut6_a = 0.105; anal.cut6_c = 0.827; anal.cut6_si = 0.08;
