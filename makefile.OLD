...
PROGRAM_SOURCES=$(shell ls *.cc)
PROGRAM_EXECUTABLES=$(shell ls *.cc|while read f; do echo .$${f%.cc}; done)

all: $(CLASSES_OBJECTS) $(PROGRAM_EXECUTABLES)

clean:
	rm -f $(CLASSES_OBJECTS)
	rm -f $(PROGRAM_EXECUTABLES)
