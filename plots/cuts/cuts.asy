...
real lim_x_low[] = { -1000, +1, -1000, -1000, -15, -15, -1500, -600 };
real lim_x_high[] = { +1000, -1, +1000, +1000, +15, +15, +1500, +600 };

real lim_y_low[] = { -1000, +1, -0.8, -0.8, -0.5, -0.5, -2, -4 };
real lim_y_high[] = { +1000, -1, +0.8, +0.8, +0.5, +0.5, +2, +4 };
