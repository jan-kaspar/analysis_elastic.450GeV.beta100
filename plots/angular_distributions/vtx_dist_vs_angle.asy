...
plot.push("vtx_x_L_vs_th_x_L"); lab_h.push("$\th_x^{*,L}\ung{\mu rad}$"); lab_v.push("$x^{*,L}\ung{\mu m}$"); x_min.push(-600); x_max.push(+600); y_min.push(-2500); y_max.push(+2500);
plot.push("vtx_x_R_vs_th_x_R"); lab_h.push("$\th_x^{*,R}\ung{\mu rad}$"); lab_v.push("$x^{*,R}\ung{\mu m}$"); x_min.push(-600); x_max.push(+600); y_min.push(-2500); y_max.push(+2500);

plot.push("vtx_y_L_vs_th_y_L"); lab_h.push("$\th_y^{*,L}\ung{\mu rad}$"); lab_v.push("$y^{*,L}\ung{\mu m}$"); x_min.push(-150); x_max.push(+150); y_min.push(-4000); y_max.push(+4000);
plot.push("vtx_y_R_vs_th_y_R"); lab_h.push("$\th_y^{*,R}\ung{\mu rad}$"); lab_v.push("$y^{*,R}\ung{\mu m}$"); x_min.push(-150); x_max.push(+150); y_min.push(-4000); y_max.push(+4000);
