...
double timestamp0 = 1525730400;

unsigned int timestamp_min = 78136;
unsigned int timestamp_max = 79615;
...
void Init_45b_56t()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -129E-6; anal.cut1_si = 40E-6;
	anal.cut2_a = 1.; anal.cut2_c = -9E-6; anal.cut2_si = 7E-6;

	//anal.cut3_c = 0.49; anal.cut3_si = 0.055;
	//anal.cut4_c = -0.03; anal.cut4_si = 0.033;

	anal.cut5_a = 0.105; anal.cut5_c = +0.877; anal.cut5_si = 0.08;
	anal.cut6_a = 0.105; anal.cut6_c = -0.950; anal.cut6_si = 0.08;

	anal.cut7_a = -1800.; anal.cut7_c = +5.; anal.cut7_si = 0.5;
	anal.cut8_a = 0.; anal.cut8_c = -49.1; anal.cut8_si = 2.;

	anal.cut9_a = -0.28; anal.cut9_c = -0.85; anal.cut9_si = 0.15;
	anal.cut10_a = -0.29; anal.cut10_c = +0.45; anal.cut10_si = 0.15;
...
void Init_45t_56b()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -444E-6; anal.cut1_si = 40E-6;
	anal.cut2_a = 1.; anal.cut2_c = +1E-6; anal.cut2_si = 7E-6;

	//anal.cut3_c = 0.43; anal.cut3_si = 0.023;
	//anal.cut4_c = -0.055; anal.cut4_si = 0.031;

	anal.cut5_a = 0.105; anal.cut5_c = 0.276; anal.cut5_si = 0.09;
	anal.cut6_a = 0.105; anal.cut6_c = 0.827; anal.cut6_si = 0.09;

	anal.cut7_a = -1800.; anal.cut7_c = 0.64; anal.cut7_si = 0.5;
	anal.cut8_a = 0.; anal.cut8_c = +15.3; anal.cut8_si = 2.;

	anal.cut9_a = -0.28; anal.cut9_c = -0.85; anal.cut9_si = 0.17;
	anal.cut10_a = -0.29; anal.cut10_c = -0.69; anal.cut10_si = 0.17;
