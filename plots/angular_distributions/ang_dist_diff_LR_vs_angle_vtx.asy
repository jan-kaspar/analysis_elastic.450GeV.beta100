...
plot.push("th_y_diffLR_vs_th_y"); x_scale.push(1e6); lab_h.push("$\th_y^{*}\ung{\mu rad}$"); lab_v.push("$\De^{R-L}\th_y^{*}\ung{\mu rad}$"); y_min.push(-30); y_max.push(+30);
plot.push("th_y_diffLR_vs_vtx_y"); x_scale.push(1e3); lab_h.push("$y^*\ung{\mu m}$"); lab_v.push("$\De^{R-L}\th_y^{*}\ung{\mu rad}$"); y_min.push(-30); y_max.push(+30);
plot.push("th_y_diffLR_vs_th_x"); x_scale.push(1e6); lab_h.push("$\th_x^{*}\ung{\mu rad}$"); lab_v.push("$\De^{R-L}\th_y^{*}\ung{\mu rad}$"); y_min.push(-30); y_max.push(+30);
plot.push("th_y_diffLR_vs_vtx_x"); x_scale.push(1e3); lab_h.push("$x^*\ung{\mu m}$"); lab_v.push("$\De^{R-L}\th_y^{*}\ung{\mu rad}$"); y_min.push(-30); y_max.push(+30);
